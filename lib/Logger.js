...
export default class {
    ...
    /**
     * Add a tag to all future log messages from this logger instance
     *
     * @param {string} tagPiece - tag to add (e.g., requestId)
     * @example
     * ```js
     * logger.addTag('req-123');
     * // Output: [service.function.req-123] Processing request
     * ```
     */
    addTag(tagPiece) {
        this.tagPieces = [ ...this.tagPieces, tagPiece ];
    }
};
